...
export default function UserDashboard() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-8"><p className="text-sm font-semibold text-emerald-600">YOUR WALLET</p><h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-900">Welcome back, {firstName}</h1><p className="mt-2 text-sm text-slate-600">Manage your money, transfers, and contacts in one secure place.</p></header>
