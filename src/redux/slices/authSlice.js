...
const createUser = ({ fullName, email, phone, emailOrPhone }) => ({
  id: 'demo-user',
  fullName: fullName || 'PesaFlow User',
  email: email || (emailOrPhone?.includes('@') ? emailOrPhone : ''),
  phone: phone || (!emailOrPhone?.includes('@') ? emailOrPhone : ''),
  role: 'user',
